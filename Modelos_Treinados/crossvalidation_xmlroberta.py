...
# Configurações
MODEL_NAME = "neuralmind/roberta-base-portuguese"  # ou "neuralmind/roberta-large-portuguese"
MODEL_DIR = "Modelos/Roberta-Base"
RESULTS_DIR = "Resultados/Roberta-Base"
MAX_LENGTH = 512
BATCH_SIZE = 4
EPOCHS = 5
LEARNING_RATE = 5e-5
...
def compute_metrics(p):
    ...
    ax.set_ylabel("True")
    ax.set_title("Confusion Matrix (NER - Unified Labels)")
    fig.colorbar(cax)
    plt.tight_layout()
